...
\begin{tikzpicture}[font=\bf\sffamily\fontsize{9}{10}\selectfont]
  \def\COLA{black!80}
  \def\COLB{Red4}
  \def\COLC{MediumBlue}
  \def\COLD{Green4}
...
\def\COLY{DarkOrange2}
 ...
 \node[anchor=north west] (A) at (0,0) {\begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=1,
...
\def\HGTA{1.3in}
       ...
       \node[anchor=south west] (B) at ([xshift=.15in]A.south east) { \begin{tikzpicture}[anchor=center]


           \begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(-.42,1.22)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{7}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=true, 
        axis on top=true,
        width=\WDT,
...
\def\OPCA{1}
 ...
 \node[anchor=north west] (C) at ([yshift=-.2in]B.south west) { \begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(.2,1.12)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{9}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=true, 
        axis on top=false,
        width=\WDT,
...
\node[anchor=north west] (D) at ($(C.north west)!(A.west)!(C.north)$) {
 \begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(-.25,1.15)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{7}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=true, 
        axis on top=true,
        width=\WDT,
...
\node[anchor=north west] (E) at ([yshift=-.1in]D.south west) {
\input{Figures/test}
};
  ...
  \node[anchor=south west] (L4) at (E.north west) {{\Large e.}};
