...
\begin{tikzpicture}[font=\bf\sffamily\fontsize{9}{9}\selectfont]
 ...
 \node[anchor=north west] (A) at (0,0) { \begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(-.25,1.12)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{7}{9}\selectfont},
...
\def\HGTA{1.2in}
       ...
       \node[anchor=south west] (B) at ([xshift=.2in,yshift=-.02in]A.south east) { \begin{tikzpicture}[anchor=center]


           \begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(-.42,1.25)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{7}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=true, 
        axis on top=true,
        width=\WDT,
...
\def\OPCA{1}
 ...
 \node[anchor=north west] (C) at ([yshift=-.1in]B.south west) { \begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=2,
      legend style={anchor=west,at={(.1,.3)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{9}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=true, 
        axis on top=false,
        width=\WDT,
...
\node[anchor=north west] (D) at ([yshift=.0in]$(C.north west)!(A.west)!(C.north)$) {
\begin{tikzpicture}[anchor=center]\begin{axis}[black, legend columns=1,
      legend style={anchor=west,at={(-.25,1.3)},inner sep=3pt,draw=none,fill=white,fill opacity=.850,align=right,text opacity=1,font=\bf\sffamily\fontsize{9}{9}\selectfont},
      axis line style={lightgray, opacity=0.01, thin},%
        enlargelimits=false, 
        axis on top=false,
        width=\WDT,
    ...
    major tick length=0pt,
     ...
     %xmode=log,ymode=log,   ymin=1e-50,
     ylabel style={align=center,font=\fontsize{8}{9}\selectfont, xshift=-.1in},
...
\node [font=\normalfont\sffamily\fontsize{8}{8}\selectfont] at (axis cs: 300,1.65) {mutation only};
\node [text=Red1,font=\normalfont\sffamily\fontsize{8}{8}\selectfont] at (axis cs: 300,.85) {mutation+selection};
  \end{axis}
\end{tikzpicture}
...
\def\WDTE{2in}
\def\HGTE{1.25in}
\node [anchor=north west] (E) at ([yshift=-.1in]D.south west) {\input{Figures/evolvability}};


  \node[anchor=south west] (L1) at ([yshift=-.05in]A.north west) {{\Large a.}};
  \node[anchor=south west] (L2) at ([yshift=-.05in]B.north west) {{\Large c.}};
  \node[anchor=south west] (L3) at ([yshift=-.0in]C.north west) {{\Large d.}};
  \node[anchor=south west] (L4) at ([yshift=-.0in]D.north west) {{\Large b.}};
  \node[anchor=south west] (L5) at ([yshift=-.0in]E.north west) {{\Large e.}};
\end{tikzpicture}
